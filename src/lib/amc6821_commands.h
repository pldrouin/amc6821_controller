...
AMC_RW_REG_FUNCTS(conf1				,AMC_CONF1			,1,	AMC_UINT8_BIN_DTYPE)
AMC_RW_REG_FUNCTS(conf2				,AMC_CONF2			,1, 	AMC_UINT8_BIN_DTYPE)
AMC_RW_REG_FUNCTS(conf3				,AMC_CONF3			,1, 	AMC_UINT8_BIN_DTYPE)
AMC_RW_REG_FUNCTS(conf4				,AMC_CONF4			,1, 	AMC_UINT8_BIN_DTYPE)
